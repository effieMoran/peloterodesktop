...
public class BillServiceImpl implements BillService {
    ...
    public Bill generateBill(Booking booking) {
        ...
        BillLine billLine = new BillLine(booking.getCombo().getPrice(), booking.getCombo().getName());
        ...
        billLine = new BillLine(booking.getDuty().getPrice(),"Servicio: " +booking.getDuty().getName());
        bill.getBillLines().add(billLine);
        bill.setTotal(bill.getTotal() + billLine.getPrice());
